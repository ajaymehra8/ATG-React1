  ...
  return (
    <section className="login d-flex align-items-center flex-column border shadow">
      <div className="head d-flex justify-content-center">
        <p><b>Let's learn, share & inspire each other with our passion for computer engineering. Sign up now 🤘🏼</b></p>
        <button className="btn" onClick={hidePage}>X</button>
      </div>

      <div className="content d-flex justify-content-between align-items-center p-5 pb-0 pt-3 w-100">
        <h3>Sign In</h3>
        <p>Don't have an account yet? <NavLink to="#" onClick={showSignUp}>Create new for free</NavLink></p>
      </div>

      <div className="mobContent p-5 pb-0 w-100">
        <h3>Welcome Back</h3>
        <button className="cutBtn" onClick={hidePage}>X</button>
      </div>
      ...
      <div className="signup-form w-100 p-5 pt-5 d-flex justify-content-center">
        ...
        <form className="d-flex w-100 flex-column signup-form">
          ...
          <div className="signIn-div d-flex justify-content-between align-items-center p-0">
            <button className="btn btn-primary mt-3 form-btn signIn-btn loginBtn">Sign in</button>
            <NavLink to="#" className="nav-link mt-3 mobLink" onClick={showSignUp}>or, Create Account</NavLink>
          </div>

          <button className="btn mt-3 form-btn border"><i className="bi bi-facebook icon" style={{color:"blue"}}></i> Sign up with Facebook</button>
